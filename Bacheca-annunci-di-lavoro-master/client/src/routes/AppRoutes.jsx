...
const ProtectedRoute = ({ allowedUserTypes }) => {
  ...
  // Se l'utente non è autenticato (dopo che isLoading è false).
  if (!isAuthenticated) {
    // Reindirizza l'utente alla pagina di login.
    // 'replace' sostituisce la voce corrente nella cronologia di navigazione invece di aggiungerne una nuova.
  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path="/login" element={<LoginPage />} /> {/* Rotta per la pagina di login. */}
        <Route path="/register" element={<RegisterPage />} /> {/* Rotta per la pagina di registrazione. */}
